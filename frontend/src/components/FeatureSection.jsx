  ...
  return (
    <section className="px-6 py-10 md:px-8">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-[30px] font-bold text-white mb-8 text-center tracking-[-0.01em]">
          Engineered for Excellence.
        </h2>
        
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          {/* Feature 1: Live Interview System */}
          <div className="md:col-span-7 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-8 flex flex-col justify-between group hover:border-[#adc6ff]/30 transition-all duration-300">
            <div>
              <div className="w-12 h-12 rounded-lg bg-[#adc6ff]/10 flex items-center justify-center text-[#adc6ff] mb-6">
                <span className="material-symbols-outlined text-[32px]">sensors</span>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Live Interview System</h3>
            ...
            <div className="relative h-40 mt-4 bg-black/40 rounded-lg overflow-hidden border border-white/5">
              <div className="absolute inset-0 bg-gradient-to-t from-[#0b0b0f] to-transparent z-10"></div>
              <div className="p-4 flex gap-4 relative z-0">
                <div className="w-1/2 h-full bg-white/5 rounded-md flex flex-col justify-center items-center py-4">
                  <div className="w-12 h-12 rounded-full border-2 border-[#adc6ff] shadow-[0_0_20px_rgba(173,198,255,0.1)] mb-2 overflow-hidden bg-zinc-800">
                  ...
                  <span className="text-xs font-medium text-[#adc6ff]">Live</span>
                </div>
                <div className="w-1/2 h-full bg-white/5 rounded-md flex flex-col justify-center items-center py-4">
                  <div className="w-12 h-12 rounded-full border-2 border-zinc-700 mb-2 overflow-hidden bg-zinc-800">
          ...
          <div className="md:col-span-5 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-8 flex flex-col group hover:border-[#adc6ff]/30 transition-all duration-300">
            <div className="w-12 h-12 rounded-lg bg-[#adc6ff]/10 flex items-center justify-center text-[#adc6ff] mb-6">
              <span className="material-symbols-outlined text-[32px]">psychology</span>
            </div>
            <h3 className="text-2xl font-bold text-white mb-4">Resume Intelligence</h3>
            <p className="text-base text-gray-400 mb-8 leading-relaxed">
              AI-powered feedback and ATS score optimization tailored for FAANG and elite tech startups.
            </p>
            
            <div className="mt-auto space-y-4 relative z-10 w-full flex-grow flex flex-col justify-end">
              ...
              <div className="p-4 bg-white/5 rounded-lg border border-white/5 flex items-center justify-between">
                ...
                <span className="text-[#adc6ff] text-xs font-bold uppercase tracking-wider">High</span>
              </div>
            </div>
          </div>
        </div>
